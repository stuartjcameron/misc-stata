...
{synoptset 15 tabbed}{...}
{p2col 5 50 20 2: }{p_end}
{synopt:{it:{help varname:outcomevar}} with no outcome values} outcome is treated as a continuous variable{p_end}

{phang}
{it:{help varname:outcomevar}}[{cmdab:=}{it:value1} [{it:value2}]]		outcome is treated as a binary variable. {it:value1} is the positive outcome, and all other non-missing values are negative outcomes.
